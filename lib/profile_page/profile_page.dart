...
class _ProfilePageWidgetState extends State<ProfilePageWidget> {
  ...
  void getInfo() async {
    ...
    responseApi =
        await PTCGetInfoCustomer.call(userName: FFAppState().userName);
    if (responseApi != null) {
      setState(() {
        isLoading = false;
      });
      if (getJsonField((responseApi?.jsonBody ?? ''), r'''$.isSuccess''')) {
        dynamic info = (getJsonField(
          (responseApi?.jsonBody ?? ''), r'''$.obj'''));
        employeeName = info['EmployeeName'].toString();
        departmentName = info['DepartmentName'].toString();
      }
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: InkWell(
                    onTap:() => {
                      context.pushNamed('EditProfile1')
                    },
                    child: Container(
                      width: double.infinity,
                      height: 50,
