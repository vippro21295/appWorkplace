...
class ChamCongChiTietTangCaWidget extends StatefulWidget {
  const ChamCongChiTietTangCaWidget({Key? key}) : super(key: key);

  @override
  _ChamCongChiTietTangCaWidgetState createState() =>
      _ChamCongChiTietTangCaWidgetState();
}

class _ChamCongChiTietTangCaWidgetState
    extends State<ChamCongChiTietTangCaWidget> {
