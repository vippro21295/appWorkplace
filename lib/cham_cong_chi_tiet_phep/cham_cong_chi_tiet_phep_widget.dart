...
class ChamCongChiTietPhepWidget extends StatefulWidget {
  const ChamCongChiTietPhepWidget({Key? key}) : super(key: key);

  @override
  _ChamCongChiTietPhepWidgetState createState() =>
      _ChamCongChiTietPhepWidgetState();
}

class _ChamCongChiTietPhepWidgetState extends State<ChamCongChiTietPhepWidget> {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FlutterFlowRadioButton(
                    options:
                        ['Nghỉ phép năm', 'Nghỉ chế độ', 'Nghỉ BHXH'].toList(),
                    onChanged: (value) {
